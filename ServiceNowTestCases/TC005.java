...
public class TC005 {
	...
	public static void main(String[] args) {
		...
		WebElement search2 = driver.findElementByXPath("(//input[@id='incident_table_header_search_control'])[1]");
		search2.clear();
		search2.sendKeys(incNo);

		// Search for the existing incident and click on the incident
		driver.findElementByXPath("//a[@class='linked formlink']").click();

		// Delete the incident
		driver.findElementByXPath("//button[@id='sysverb_delete_bottom']").click();
